...
outf="outputs/cifar10_cnn_niid_${alpha}/outputs"
logf="outputs/cifar10_cnn_niid_${alpha}/log"
...
options=" --num-rounds ${num_rounds} --eval-every ${eval_every} --clients-per-round ${clients_per_round} --num_epochs ${num_epochs} -reg_param $reg --m0 ${m0} --gpu 1"
