...
MODEL_PARAMS = {
    ...
    'cifar10.erm_cnn_log_reg': (2e-2, 10, 16384),
    # Shakespeare
...
CORRUPTION_FLIP_KEY = 'labelflip'
CORRUPTION_OMNISCIENT_KEY = 'omniscient'
CORRUPTION_P_X_KEY = 'p_x'
CORRUPTION_GAUSS_KEY = 'gauss'
CORRUPTION_GAUSS2_KEY = 'gauss2'
CORRUPTION_EMPIRE_KEY = 'empire'
CORRUPTION_LITTLE_KEY = 'little'
CORRUPTION_SIGNFLIP_KEY = 'signflip'
CORRUPTION_PGA_KEY = 'pga'


AGGR_MEAN = 'mean'
AGGR_MEBWO = 'minimum_enclosing_ball_with_outliers'
AGGR_MEBWO1 = 'minimum_enclosing_ball_with_outliers1'
AGGR_MEBWO_IN = 'minimum_enclosing_ball_with_outliers_in'
AGGR_MEBWO_OUT = 'minimum_enclosing_ball_with_outliers_out'
